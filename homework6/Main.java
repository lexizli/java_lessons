...
public class Main {
    public static void main(String[] args) {
        ...
        stock.put(1, new Notebooks(
                "Guomi", "OLOEY Intel N5105 ", "Windows 10 Pro", "1920x1080", "Intel Celeron N5105", "Integrated",
                "Intel",
        ...
        stock.put(6, new Notebooks(
                "Asus", "ROG Zephyrus duo 16 GX650", "Windows 11 Pro", "1920x1080", "AMD Ryzen 9 7945HX ",
                "GeForce RTX 4090 (24 Гб)", "NVIDIA",
                16, 36.38, 1.99, 24.35, 924000, 3000, 2, 4, 3200, 64000, 4096000, 3000));
        stock.put(7, new Notebooks(
        ...
        for (Map.Entry<Integer, Notebooks> note : stock.entrySet()) {
            ...
            // if (noteTM.equals("Hvatomi")) {
            //     System.out.println(noteTM);
            // }

        }
        System.out.println(stock.get(4).equals(stock.get(3)));
